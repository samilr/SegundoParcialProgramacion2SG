...
namespace CapaDatos
{
    public class CD_Contactos
    {
        ...
        public void Insertar(string name, string lastName, string address, string dateBirthday, string phoneNumber)
        {
            //PROCEDIMNIENTO
        ...
        public void Editar(string name, string lastName, string address, string dateBirthday, string phoneNumber, int id)
        {
